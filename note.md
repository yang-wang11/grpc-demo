...
➜ pwd
product/pb
➜ protoc  --go_out=../pb --go-grpc_out=../pb product.proto
➜ ls -al ../
drwxr-xr-x@ 4 elan  staff  128 Jan 29 00:42 pb
drwxr-xr-x@ 4 elan  staff  128 Jan 29 00:46 product
➜ ls -al ../product 
-rw-r--r--@ 1 elan  staff  6883 Jan 29 00:46 product.pb.go
-rw-r--r--@ 1 elan  staff  3777 Jan 29 00:46 product_grpc.pb.go
...
找到openssl.cnf 文件（ openssl version -d  ）
...
func main() {
	...
	creds, err := credentials.NewClientTLSFromFile("../../certs/server.pem", "grpc.local")
	if err != nil {
		panic(err)
	}
